...
kubectl -n ckan-cloud create configmap operator-conf --from-literal=ckan-cloud-operator-image=orihoch/ckan-cloud-operator:latest --from-literal=label-prefix=ckan-cloud
```
